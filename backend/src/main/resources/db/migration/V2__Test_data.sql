...
VALUES
-- Smartfony
(4, 'iPhone 15 Pro', 'Najnowszy model iPhone z układem A17 Pro', 5499.99),
(4, 'Samsung Galaxy S24', 'Flagowy smartfon Samsung z ekranem AMOLED', 4299.99),
(4, 'Xiaomi 13', 'Smartfon z doskonałym aparatem', 2799.99),
(4, 'Google Pixel 8', 'Czysty Android z najlepszym aparatem', 3499.99),

-- Telewizory
(5, 'Samsung QLED 65"', 'Telewizor QLED 4K z HDR', 4999.99),
(5, 'LG OLED 55"', 'Telewizor OLED z idealną czernią', 5999.99),
(5, 'Sony Bravia 50"', 'Smart TV 4K z Android TV', 3299.99),
(5, 'TCL 43" Smart TV', 'Budżetowy Smart TV z 4K', 1599.99),

-- Komputery
(3, 'MacBook Pro 14"', 'Laptop profesjonalny z M3 Pro', 9999.99),
(3, 'Dell XPS 15', 'Laptop z procesorem Intel i7', 7499.99),
(3, 'Lenovo ThinkPad', 'Laptop biznesowy z matową matrycą', 5999.99),
(3, 'ASUS ROG Strix', 'Laptop gamingowy z RTX 4070', 8999.99),

-- AGD
(2, 'Lodówka Samsung', 'Lodówka side-by-side No Frost', 3499.99),
(2, 'Pralka Bosch', 'Pralka automatyczna 8kg A+++', 2299.99),
(2, 'Zmywarka Siemens', 'Zmywarka 60cm z funkcją Auto Open', 2799.99),
(2, 'Ekspres DeLonghi', 'Ekspres ciśnieniowy do kawy', 1899.99),

-- Audio
(6, 'Sony WH-1000XM5', 'Słuchawki z ANC najwyższej klasy', 1499.99),
(6, 'Bose QuietComfort', 'Komfortowe słuchawki z redukcją szumów', 1299.99),
(6, 'JBL Flip 6', 'Przenośny głośnik Bluetooth', 499.99),
(6, 'Soundbar Samsung', 'Soundbar 3.1 z subwooferem', 1999.99),

-- Gaming
(7, 'PlayStation 5', 'Konsola nowej generacji', 2499.99),
(7, 'Xbox Series X', 'Konsola Xbox z 4K', 2299.99),
(7, 'Nintendo Switch OLED', 'Przenośna konsola z ekranem OLED', 1499.99),
(7, 'Steam Deck', 'Handheld PC do gier', 1999.99),

-- Akcesoria
(8, 'Magic Keyboard', 'Klawiatura bezprzewodowa Apple', 599.99),
(8, 'Logitech MX Master', 'Mysz ergonomiczna dla profesjonalistów', 399.99),
(8, 'USB-C Hub', 'Rozszerzenie portów 7w1', 199.99),
(8, 'Etui iPhone 15', 'Silikonowe etui z MagSafe', 199.99);
